        ...
        public static async Task SeedDesafios(TullyContext context)
        {
            if (!context.Desafios.Any())
            {
                var desafios = new List<Desafio>
                {
                    ...
                    {
                        Nome = "Praça da Sé",
                        Endereço = "Praça da Sé, 92",
                        Descrição = "A Praça da Sé é um espaço público localizado no bairro da Sé, " +
                    ...
                    new Desafio()
                    {
                        ...
                        Endereço = "Av. Paulista, 92",
                        Descrição = "A Avenida Paulista é um dos logradouros mais importantes do município " +
                    ...
                    new Desafio()
                    {
                        ...
                        Descrição = "O Parque Ibirapuera é o mais importante parque urbano da cidade de São Paulo, " +
                    ...
                    new Desafio()
                    {
                        ...
                        Endereço = "Av. Olavo Fontoura, 1200",
                        Descrição = "O Anhembi Parque (antiga Arena Skol Anhembi) é um complexo cultural-comercial " +
                    ...
                    new Desafio()
                    {
                        ...
                        Endereço = "Praça Comandante Linneu Gomes",
                        Descrição = "O Aeroporto de São Paulo/Congonhas - Deputado Freitas Nobre, ou simplesmente " +
